...
(sudo crontab -l ; echo "@reboot sh /home/machinekit/ProBot/ProBot_BeagleBone/RestartProgram_ZMQ.py") |sudo crontab -
(sudo crontab -l ; echo "@reboot sh /home/machinekit/ProBot/ProBot_BeagleBone/RestartProgram.py") |sudo crontab -
