...
class PIDControllers():
    # Build a constructor
    def __init__(self, error=0, Matrix=0, KpP_UC33=0, KiP_UC33=0, KdP_UC33=0, KpV_UC33=0, KiV_UC33=0, KdV_UC33=0, KpA_UC33=0, KiA_UC33=0, KdA_UC33=0, lock=0):
        self.error = error
	...
	self.KpA_UC33=(0.1*self.Matrix[28]+0.01*self.Matrix[20]+0.001*self.Matrix[12]-0.1*self.Matrix[4])
	self.KiA_UC33=(0.1*self.Matrix[29]+0.01*self.Matrix[21]+0.001*self.Matrix[13]-0.1*self.Matrix[5])
	self.KdA_UC33=(0.1*self.Matrix[30]+0.01*self.Matrix[22]+0.001*self.Matrix[14]-0.1*self.Matrix[6])
	self.KpV_UC33=(0.1*self.Matrix[31]+0.01*self.Matrix[23]+0.001*self.Matrix[15]-0.1*self.Matrix[7])
	self.KiV_UC33=(0.1*self.Matrix[32]+0.01*self.Matrix[24]+0.001*self.Matrix[16]-0.1*self.Matrix[8])
	self.KdV_UC33=(0.1*self.Matrix[33])

	# Loading the variables for the controllers
        typeController = {'Position1': [Pconst.KpP+self.KpP_UC33, Pconst.KiP+self.KiP_UC33, Pconst.KdP+self.KdP_UC33, Pconst.limitP, Pconst.integrated_error_P, Pconst.last_error_P], 'Position2': [Pconst.KpP+self.KpP_UC33, Pconst.KiP+self.KiP_UC33, Pconst.KdP+self.KdP_UC33, Pconst.limitP, Pconst.integrated_error_P1, Pconst.last_error_P1], 'Velocity': [Pconst.KpV+self.KpV_UC33, Pconst.KiV+self.KiV_UC33, Pconst.KdV+self.KdV_UC33, Pconst.limitV, Pconst.integrated_error_VA, Pconst.last_error_VA], 'Angle': [Pconst.KpA+self.KpA_UC33, Pconst.KiA+self.KiA_UC33, Pconst.KdA+self.KdA_UC33, Pconst.limitA, Pconst.integrated_error_VA, Pconst.last_error_VA]}
